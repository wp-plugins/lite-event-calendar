...
global $dpProEventCalendar, $current_user;
	...
	add_submenu_page('dpProEventCalendar-admin', __('Get More Features!', 'dpProEventCalendar'), __('Get More Features!', 'dpProEventCalendar'), 'edit_posts', 'dpProEventCalendar-pro', 'dpProEventCalendar_pro_page');
}
